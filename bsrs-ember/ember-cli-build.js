...
module.exports = function(defaults) {
  ...
  if(app.env !== 'production') {
    ...
    app.import('vendor/defaults/automation-action.js');
    app.import('vendor/defaults/automation-action-type.js');
    app.import('vendor/defaults/automation-event.js');
    app.import('vendor/defaults/automation-join-action.js');
