...
var ChildrenMixin = Ember.Mixin.create({
    ...
    // }),
    // children: many_models('location_children', 'children_pk', 'location'),
    ...
    add_child_container: add_many_to_many('children', 'location_children', 'location'),
    // remove_children remove_many_to_many('location-children', 'children_pk', 'location_children'),
