...
export default GridViewComponent.extend({
  ...
  columns: [
    {field: 'status.translated_name', headerLabel: 'admin.person.label.status', headerIsTranslatable: true, isSortable: true, isFilterable: true, isSearchable: true, templateName: 'tickets/ticket-status-tag', classNames: ['person-status'] },
    {field: 'fullname', headerLabel: 'admin.person.label.fullname', headerIsTranslatable: true, isSortable: true, isFilterable: true, isSearchable: true},
