...
export default GridViewComponent.extend({
    ...
    columns: [
        {field: 'status.translated_name', headerLabel: 'person.label.status-name', headerIsTranslatable: true, isSortable: true, isFilterable: true, isSearchable: true, templateName: 'tickets/ticket-status-tag', classNames: ['person-status'] },
