...
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 0);
//  });
//  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=2`, 'GET',null,{},200,RF.list_two());
//  click('.t-page:eq(1) a');
//  andThen(() => {
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 0);
//  });
//  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&page_size=${updated_pg_size}`, 'GET',null,{},200,RF.paginated(PAGE_SIZE));
//  alterPageSize('.t-page-size', updated_pg_size);
//  andThen(() => {
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 0);
//  });
//  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&ordering=name&page_size=${updated_pg_size}` ,'GET',null,{},200,RF.paginated(updated_pg_size));
//  click(SORT_NAME_DIR);
//  andThen(() => {
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 1);
//  });
...
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 0);
//  });
//  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&page_size=${updated_pg_size}&name__icontains=xav` ,'GET',null,{},200,RF.list());
//  filterGrid('name', 'xav');
//  andThen(() => {
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 1);
//  });
//  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&ordering=name&page_size=${updated_pg_size}&name__icontains=xav`, 'GET',null,{},200,RF.paginated(PAGE_SIZE));
//  click(SORT_NAME_DIR);
//  andThen(() => {
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 1);
//  });
//  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&ordering=name&page_size=${PAGE_SIZE}&name__icontains=xav`, 'GET',null,{},200,RF.paginated(PAGE_SIZE));
//  alterPageSize('.t-page-size', PAGE_SIZE);
//  andThen(() => {
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 1);
//  });
//  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=2&ordering=name&page_size=${PAGE_SIZE}&name__icontains=xav`, 'GET',null,{},200,RF.paginated(PAGE_SIZE));
//  click('.t-page:eq(1) a');
//  andThen(() => {
//    assert.equal(find(SAVE_FILTERSET_MODAL).length, 1);
//  });
...
test('applying a saved filterset will reset the page to 1 by default', function(assert) {
  ...
  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&ordering=name&name__icontains=xav` ,'GET',null,{},200,RF.paginated(updated_pg_size));
...
test('each time you apply a saved filterset the query params are reset to reflect only the currently active filterset', function(assert) {
  ...
  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&search=zap&name__icontains=xav` ,'GET',null,{},200,RF.paginated(PAGE_SIZE));
  click('.t-filterset-wrap div:eq(0) a');
  andThen(() => {
    assert.equal(find(SAVE_FILTERSET_MODAL).length, 0);
  ...
  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&ordering=name&search=admin` ,'GET',null,{},200,RF.paginated(PAGE_SIZE));
...
skip('after saving a filterset the save button button is not visible', function(assert) {
  ...
  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&ordering=name` ,'GET',null,{},200,RF.paginated(PAGE_SIZE));
  click(SORT_NAME_DIR);
  andThen(() => {
    assert.equal(find(SAVE_FILTERSET_MODAL).length, 1);
  });
...
skip('adding a new filterset with search will still allow the search input to be updated when another is applied', function(assert) {
  ...
  xhr(`${PREFIX}${ROLE_LIST_URL}/?page=1&ordering=name&search=4` ,'GET',null,{},200,RF.paginated(PAGE_SIZE));
  fillIn('.t-grid-search-input', '4');
  triggerEvent('.t-grid-search-input', 'keyup', NUMBER_FOUR);
  andThen(() => {
