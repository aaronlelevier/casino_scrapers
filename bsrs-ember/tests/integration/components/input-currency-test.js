...
moduleForComponent('input-currency', 'integration: input-currency test', {
    ...
    setup() {
        ...
        run(function() {
            ...
            currencyObject = store.push('currency', {id:CD.id, symbol:CD.symbol, name:CD.name, decimal_digits:CD.decimal_digits, code:CD.code, name_plural:CD.name_plural, rounding:CD.rounding, symbol_native:CD.symbol_native});
        });
