...
//TODO: bring back test after fix component
...
//     var subject = PersonListComponent.create({model: {model: store.find('person')}, query_django: function() {}});
...
//     var subject = PersonListComponent.create({model: {model: store.find('person')}, itemsPerPage: 2, query_django: function() {}});
...
//     model.set('count', 4);
//     var subject = PersonListComponent.create({model: {model: model}, itemsPerPage: 2, query_django: function() {}});
