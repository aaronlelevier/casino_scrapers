...
//     assert.equal(location_select.get('all_locations').get('length'), 1);
...
//     assert.equal(location_select.get('all_locations').get('length'), 2);
...
//     assert.equal(location_select.get('all_locations').get('length'), 3);
