...
test('it works', function(assert) {
  ...
  result = automationAction([Ember.Object.create({'key': 'automation.actions.sendemail'})]);
  assert.equal(result, 'automations/sendemail-action');
  result = automationAction([Ember.Object.create({'key': 'automation.actions.sendsms'})]);
