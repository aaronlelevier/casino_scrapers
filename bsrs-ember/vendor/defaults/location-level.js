var BSRS_LOCATION_LEVEL_DEFAULTS_OBJECT = (function() {
    ...
    factory.prototype.defaults = function() {
        return {
            ...
            nameFacilityManagement: 'admin.locationlevel.facility_management',
            nameLossPreventionRegion: 'admin.locationlevel.loss_prevention_region',
            nameDistrict: 'admin.locationlevel.district',
            lossPreventionDistrict: 'admin.locationlevel.loss_prevention_district',
            nameDepartment: 'admin.locationlevel.department',
            nameGrid: 'admin.locationlevel.company.tsiname16',
            nameStore: 'Store',
            nameStoreUn: 'admin.locationlevel.store',
