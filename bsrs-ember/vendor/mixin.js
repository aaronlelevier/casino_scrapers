var BSRS_LIST_FIXTURE_MIXIN = (function() {
  ...
  factory.prototype.paginated = function(page_size) {
    ...
    return {'count':19,'next':null,'previous':null,'results': paginated};
  };
  ...
  factory.prototype.sorted_page_one = function(column) {
    var page1 = this.list().results;
    var response = page1;
    var columns = column.split(',');
    var column = columns[0];
    var sorted = response.sort(function(a,b) {
    ...
    return {'count':sorted.length*2,'next':null,'previous':null,'results': sorted};
  };

  factory.prototype.sorted_page_two = function(column) {
    var page1 = this.list_two().results;
    var response = page1;
    var columns = column.split(',');
    var column = columns[0];
  ...
  factory.prototype.searched_page_two = function(search, column, page) {
    var page1 = this.list_two().results;
    var response = page1;
