    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('deleted', models.DateTimeField(help_text=b'If NULL the record is not deleted, otherwise this is the timestamp of when the record was deleted.', null=True, blank=True)),
                ('role_type', models.CharField(default=b'contractor', max_length=29, blank=True, choices=[(b'contractor', b'contractor'), (b'location', b'location')])),
                ...
                ('default_auth_amount', models.DecimalField(default=0, help_text=b'The default amount here will be eventually set by system settings.', max_digits=15, decimal_places=4, blank=True)),
                ...
                ('default_auth_amount_currency', models.ForeignKey(blank=True, to='accounting.Currency', help_text=b"The default currency is 'usd'.", null=True)),
