    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_amount', models.DecimalField(blank=True, decimal_places=4, max_digits=15, null=True)),
                ('accept_assign', models.NullBooleanField()),
                ('accept_notify', models.NullBooleanField()),
                ...
                ('password_one_time', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('deleted', models.DateTimeField(blank=True, help_text='If NULL the record is not deleted, otherwise this is the timestamp of when the record was deleted.', null=True)),
                ('role_type', models.CharField(blank=True, choices=[('admin.role.type.internal', 'admin.role.type.internal'), ('admin.role.type.third_party', 'admin.role.type.third_party')], default='admin.role.type.internal', max_length=29)),
                ...
                ('auth_amount', models.DecimalField(blank=True, decimal_places=4, default=0, max_digits=15, null=True)),
                ...
                ('inv_options', models.CharField(choices=[('admin.invoice.new', 'admin.invoice.new'), ('admin.invoice.draft', 'admin.invoice.draft')], default='admin.invoice.new', max_length=255)),
                ('inv_wait', models.PositiveIntegerField(blank=True, null=True)),
                ('inv_select_assign', models.CharField(choices=[('admin.invoice.select_assign.all', 'admin.invoice.select_assign.all'), ('admin.invoice.select_assign.managers', 'admin.invoice.select_assign.managers')], default='admin.invoice.select_assign.all', max_length=255)),
                ...
                ('inv_close_wo', models.CharField(choices=[('admin.work_order.close.do_not_display', 'admin.work_order.close.do_not_display'), ('admin.work_order.close.unchecked', 'admin.work_order.close.unchecked'), ('admin.work_order.close.checked', 'admin.work_order.close.checked')], default='admin.work_order.close.do_not_display', max_length=255)),
