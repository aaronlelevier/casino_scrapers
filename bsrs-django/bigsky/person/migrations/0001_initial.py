...
>>>>>>> master
                ...
                ('proxy_start_date', models.DateField(max_length=100, verbose_name='Out of the Office Status Start Date', null=True, blank=True)),
                ('proxy_end_date', models.DateField(max_length=100, verbose_name='Out of the Office Status End Date', null=True, blank=True)),
                ...
                ('locale', models.ForeignKey(to='translation.Locale', help_text="If the Person has not 'Locale', the Accept-Language header will be used or the Site's system setting.", blank=True, null=True)),
                ('locations', models.ManyToManyField(to='location.Location', related_name='people', blank=True)),
                ('next_approver', models.ForeignKey(to=settings.AUTH_USER_MODEL, blank=True, null=True, related_name='nextapprover')),
                ('proxy_user', models.ForeignKey(to=settings.AUTH_USER_MODEL, blank=True, null=True, related_name='coveringuser')),
            ],
            options={
                'ordering': ('fullname',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(unique=True, max_length=100, help_text='Will be set to the Group Name')),
...
>>>>>>> master
                ...
                ('default_auth_amount', models.DecimalField(decimal_places=4, max_digits=15, default=0, blank=True)),
...
>>>>>>> master
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='auth.Permission', verbose_name='user permissions', blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user'),
        ),
    ]
