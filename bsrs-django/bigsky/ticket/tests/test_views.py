...
class TicketDetailTests(TicketSetupMixin, APITestCase):
    ...
    def test_data(self):
        ...
        self.assertEqual(data['work_orders'][0]['cost_estimate_currency'], str(work_order.cost_estimate_currency.id))
        self.assertEqual(data['work_orders'][0]['cost_estimate'], str(work_order.cost_estimate))
        self.assertIn('gl_code', data['work_orders'][0])
        ...
        self.assertIn('instructions', data['work_orders'][0])
        self.assertEqual(data['work_orders'][0]['approver']['id'], str(work_order.approver.id))
        self.assertEqual(data['work_orders'][0]['approver']['first_name'], work_order.approver.first_name)
        self.assertEqual(data['work_orders'][0]['approver']['middle_initial'], work_order.approver.middle_initial)
        self.assertEqual(data['work_orders'][0]['approver']['last_name'], work_order.approver.last_name)
        self.assertNotIn('photo', data['work_orders'][0]['approver'])
        self.assertEqual(data['work_orders'][0]['tracking_number'], work_order.tracking_number)
        self.assertEqual(data['work_orders'][0]['status']['id'], str(work_order.status.id))
        self.assertEqual(data['work_orders'][0]['status']['name'], work_order.status.name)
        self.assertEqual(data['work_orders'][0]['category']['id'], str(work_order.category.id))
        self.assertEqual(data['work_orders'][0]['category']['name'], work_order.category.name)
        self.assertEqual(data['work_orders'][0]['category']['description'], work_order.category.description)
        self.assertEqual(data['work_orders'][0]['category']['cost_amount'], work_order.category.cost_amount)
        self.assertEqual(data['work_orders'][0]['category']['cost_currency'], str(work_order.category.cost_currency.id))
        self.assertEqual(data['work_orders'][0]['category']['cost_code'], work_order.category.cost_code)
        self.assertEqual(data['work_orders'][0]['category']['label'], work_order.category.label)
        self.assertEqual(data['work_orders'][0]['category']['display_name'], work_order.category.parents_and_self_as_string())
        self.assertEqual(data['work_orders'][0]['provider']['id'], str(work_order.provider.id))
        self.assertEqual(data['work_orders'][0]['provider']['name'], work_order.provider.name)
        self.assertEqual(data['work_orders'][0]['provider']['logo'], work_order.provider.logo)
        self.assertEqual(data['work_orders'][0]['provider']['address1'], work_order.provider.address1)
        self.assertEqual(data['work_orders'][0]['provider']['address2'], work_order.provider.address2)
        self.assertEqual(data['work_orders'][0]['provider']['city'], work_order.provider.city)
        self.assertEqual(data['work_orders'][0]['provider']['state'], work_order.provider.state)
...
class TicketCreateTests(TicketSetupMixin, APITestCase):
    ...
    def test_data(self):
        ...
        self.data.update({
            ...
            'request': 'plumbing',
            'completion_date': now(),
            'status': str(create_ticket_status(TicketStatus.IN_PROGRESS).id)
        })
