...
router.register(r'admin/automation-available-filters', routing_views.AvailableFilterViewSet)
router.register(r'admin/automation-events', routing_views.RoutingEventViewSet)
# TENANT
