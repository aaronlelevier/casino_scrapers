...
class SeleniumTests(JavascriptMixin, LoginMixin, FillInHelper, MethodHelpers, unittest.TestCase):
    ...
    #     nav_page = NavPage(self.driver, self.wait, self.driver_wait)
    ...
    #     role_page = RolePage(self.driver, self.wait, self.driver_wait)
    ...
    #     self._fill_in(role)
    #     gen_elem_page = GeneralElementsPage(self.driver, self.wait, self.driver_wait)
    ...
    #     location_page = LocationPage(self.driver, self.wait, self.driver_wait)
    ...
    def test_location_level(self):
        ...
        # Go to Create view
        location_level_page = LocationLevelPage(self.driver, self.wait, self.driver_wait)
    ...
    def test_person(self):
        ...
        person_page = PersonPage(self.driver, self.wait, self.driver_wait)
