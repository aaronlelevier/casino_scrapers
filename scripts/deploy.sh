...
wait
../venv/bin/python manage.py makemigrations accounting assignment category contact dt dtd generic location person session setting tenant third_party ticket translation utils work_order work_request
